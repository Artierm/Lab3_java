package bsu.rfe.java.group7.lab3.Ermak.varA;
    ...
    public Main (Double[] coefficients) {
        ...
        Action aboutProgramAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                JLabel author = new JLabel("Автор: Ермак Артем");
                JLabel group = new JLabel("студент 7 группы");
                JLabel image=new JLabel(new ImageIcon(Main.class.getResource("java_orc.jpg")));
